...
export function ChatInterface() {
  ...
  const [relatedItems, setRelatedItems] = useState<SourceArticle[]>([]);
  ...
  useEffect(() => {
    ...
    const loadRelated = async () => {
      ...
      try {
        ...
        console.error("Erro ao buscar conteúdos relacionados no chat:", err);
      } finally {
        ...
        <div className="absolute inset-0 bg-slate-900/40 backdrop-blur-xs flex justify-end z-50">
          <div className="w-[85%] md:w-[450px] bg-white h-full shadow-2xl flex flex-col p-6 overflow-y-auto animate-in slide-in-from-right duration-200">
            ...
            <div className="pt-6 pb-8">
              <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3 animate-fade-in">
                Conteúdos Relacionados
              </h4>
              {isRelatedLoading ? (
